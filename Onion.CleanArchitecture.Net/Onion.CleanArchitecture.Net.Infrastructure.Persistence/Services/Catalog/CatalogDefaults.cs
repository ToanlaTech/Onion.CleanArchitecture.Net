...
/// </summary>
public static partial class CatalogDefaults
{
    #region Common
    ...
    /// </remarks>
    // public static CacheKey CategoriesAllCacheKey => new("Nop.category.all.{0}-{1}-{2}", EntityCacheDefaults<Category>.AllPrefix);
    ...
    /// {2} : show hidden records?
    /// </remarks>
    // public static CacheKey ProductTagCountCacheKey => new("Nop.producttag.count.{0}-{1}-{2}", EntityCacheDefaults<ProductTag>.Prefix);
    ...
    /// {0} : product ID
    /// </remarks>
    // public static CacheKey ProductTagsByProductCacheKey => new("Nop.producttag.byproduct.{0}", EntityCacheDefaults<ProductTag>.Prefix);
