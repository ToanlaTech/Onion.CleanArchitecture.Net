...
using Onion.CleanArchitecture.Net.Domain.Entities.Security;
using Onion.CleanArchitecture.Net.Domain.Entities.Seo;
using Onion.CleanArchitecture.Net.Domain.Entities.Stores;

namespace Onion.CleanArchitecture.Net.Domain.Entities.Catalog
{
    public class Product : AuditableBaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountProductMapping>, ISoftDeletedEntity
    {
        /// <summary>
