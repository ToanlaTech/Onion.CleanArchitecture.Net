...
namespace Onion.CleanArchitecture.Net.Tests.Caching;

[TestFixture]
public class MemoryCacheManagerTests : BaseTest
{
    ...
    public void Setup()
    {
        _staticCacheManager = (MemoryCacheManager)GetService<IStaticCacheManager>();
        if (_staticCacheManager == null)
        {
            throw new InvalidOperationException("Service IStaticCacheManager is not of type MemoryCacheManager.");
        }
    }
