...
using Onion.CleanArchitecture.Net.Consumer.Consumer;
using Onion.CleanArchitecture.Net.Infrastructure.Shared.Environments;
using System;
using System.Collections.Generic;

namespace Onion.CleanArchitecture.Net.Consumer.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            ...
            {
                c.IncludeXmlComments(string.Format(@"Onion.CleanArchitecture.Net.Consumer.xml"));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "Clean Architecture - Onion.CleanArchitecture.Net.WebApi",
