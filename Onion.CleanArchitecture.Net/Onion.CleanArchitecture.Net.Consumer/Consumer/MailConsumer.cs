...
using Onion.CleanArchitecture.Net.Application.Publishers;
using System;
using System.IO;
using System.Threading.Tasks;

namespace Onion.CleanArchitecture.Net.Consumer.Consumer
{
        ...
        public async Task Consume(ConsumeContext<MailPublisher> context)
        {
            ...
            if (File.Exists(mailPath))
            {
                ...
                await _EmailService.SendMailsAsync(new EmailRequests()
                {
                    ...
                    From = "'toananhle'<no_reply@toananhle.com.vn>",
                    Subject = "Subject",
