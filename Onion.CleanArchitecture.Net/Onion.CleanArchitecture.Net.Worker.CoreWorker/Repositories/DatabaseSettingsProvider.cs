...
using Onion.CleanArchitecture.Net.CoreWorker.Environments;
using Onion.CleanArchitecture.Net.CoreWorker.Interfaces;

namespace Onion.CleanArchitecture.Net.CoreWorker.Repositories
{
    public class DatabaseSettingsProvider : IDatabaseSettingsProvider
    {
        private readonly IHostEnvironment _env;
        private readonly IConfiguration _config;
        public DatabaseSettingsProvider(IHostEnvironment env, IConfiguration config)
        {
            _env = env;
            _config = config;
        }
